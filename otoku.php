...
<body>
  ...
  <nav id="menubar">
    <ul class="inner">
      ...
      <li class="current"><a href="otoku.php">お得カレンダー</a></li>
      ...
      <div class="contents">
        <div class="inner">
          ...
          <aside class="slidersize">
            <h2 id="newinfo_hdr" class="close">お得カレンダー<span>Movie review</span></h2>
            <iframe src="https://calendar.google.com/calendar/embed?height=600&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=3c2jsb6e1tssaces54dh59n82k%40group.calendar.google.com&amp;color=%23B1365F&amp;ctz=Asia%2FTokyo" style="border-width:0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
