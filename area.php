            ...
            <div class="contents">
                <div class="inner">
                    ...
                    <section id="new">
                        ...
                        <p><B>千葉県の映画館</B></p>
                        <table border="auto" style="margin:30px;">

                            <tr>
                                <td align="center">イオンシネマ千葉ニュータウン</td>
                                <td align="center">USシネマ千葉ニュータウン</td>
                                <td align="center">イオンシネマ幕張新都心</td>
                                <td align="center">シネプレックス幕張</td>
                                <td align="center">キネマ旬報シアター</td>
                            </tr>
                            <tr>
                                <td align="center">TOHOシネマズ柏</td>
                                <td align="center">京成ローザ10</td>
                                <td align="center" align="center">千葉劇場</td>
                                <td align="center">旭サンモールシネマ</td>
                                <td align="center">イオンシネマ市川妙典</td>
                            </tr>
                            <tr>
                                <td align="center">イオンシネマ銚子</td>
                                <td align="center">イオンスペースシネマ野田</td>
                                <td align="center">シネマイクスピアリ</td>
                                <td align="center">シネマサンシャインユーカリが丘</td>
                                <td align="center">Tジョイ蘇我</td>
                            </tr>
                            <tr>
                                <td align="center">TOHOシネマズ市川コルトンプラザ</td>
                                <td align="center">TOHOシネマズ市原</td>
                                <td align="center">TOHOシネマズ流山おおたかの森</td>
                                <td align="center">TOHOシネマズ八千代緑が丘</td>
                                <td align="center">TOHOシネマズららぽーと船橋</td>
                            </tr>
                            <tr>
                                <td align="center">成田HUMAXシネマズ</td>
                                <td align="center">MOVIX柏の葉</td>
                                <td align="center"><a href="theater.php">USシネマ木更津</a></td>
                                <td align="center">USシネマちはら台</td>
                            </tr>   
                        </table>
                        ...
                        <br>
                        <P align="right"><a href="theasea.php"><u>前の画面に戻る</u></a></P>
