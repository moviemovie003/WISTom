...
<body>
  ...
  <nav id="menubar">
    <ul class="inner">
      ...
      <li class="current"><a href="review.php">映画レビュー</a></li>
  ...
  <nav id="menubar-s">
    <ul>
      ...
      <li><a href="Error.html">おすすめ映画診断</a></li>
      ...
      <div class="contents">
        <div class="inner">
          ...
          <aside class="slidersize">
            <h2 id="newinfo_hdr" class="close">映画レビュー<span>Movie review</span></h2>
            <p class="title">新着映画レビュー</p>
            
            <table class="review">
                <tr>
                  <td><img src="images/MI6%20fallout%20(1).JPG" width="100" height="100" alt="" align="left" id="reviewimg"><div class="movietitle">ミッションインポッシブルフォールアウト</div>
                   <p class="subject">少女との絆に感動！！</p>
                    <p id="reviewa">ここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入ります</p>
                    <div class="hyouka">★★★★☆</div>
                    <div class="date">掲載日：2018年10月11日</div>
                  </td>
                </tr>
                <tr>
                  <td><img src="images/Oceans8%20(4).jpg" width="100" height="100" alt="" align="left" id="reviewimg"><div class="movietitle">オーシャンズ8</div>
                   <p class="subject">映画を盗撮してみたいと思った！！</p>
                    <p id="reviewa">ここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入ります</p>
                    <div class="hyouka">★★★★☆</div>
                    <div class="date">掲載日：2018年10月11日</div>
                  </td>
                ...
                <tr>
                  <td><img src="images/poster%20(51).jpg" width="100" height="100" alt="" align="left" id="reviewimg"><div class="movietitle">ジュマンジ ウェルカムトゥージャングル</div>
                   <p class="subject">映画を盗撮してみたいと思った！！</p>
                    <p id="reviewa">ここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入りますここにレビュー本文が入ります</p>
                    <div class="hyouka">★★★★☆</div>
                    <div class="date">掲載日：2018年10月11日</div>
