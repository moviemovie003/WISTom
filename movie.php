...
<body>
    ...
    <a href="https://www.disney.co.jp/movie/sugarrush-ol.html">
        ...
        <div id="main">
            ...
            <div class="contents">
                <div class="inner">
                    ...
                    <section id="new">
                        <h2 id="newinfo_hdr" class="close">作品詳細</h2>
                        
                        <?php
                            $movieId = "2018110901";
        $result = mysqli_query($link , "SELECT * FROM movie WHERE タイトルID=" . $movieId);  
        ...
        ?>
                        ...
                        <p><big><?php echo "{$row['タイトル']}" ;?></big></p>

                        <table border="0" align="left">
                            <tr>
                                <td><img src="images/bohemian%20(5).JPG" width="190" height="60" vspace="30" hspace="45"></td>
                            </tr>
                        </table>
                        <br><br>
                        <table border="3" width="320" height="180">
                            <tr>
                                <th>監督</th>
                                <td><?php echo "{$row['監督']}" ;?></td>
                            </tr>
                            <tr>
                                <th>公開日</th>
                                <td><?php echo "{$row['公開年']}" ;?></td>
                            </tr>

                            <tr>
                                <th>公式サイト</th>
                                <td><a href="http://www.foxmovies-jp.com/bohemianrhapsody/">公式サイトへ</a></td>
                            </tr>
                        </table>
                        <br> <br> <br> <br>
                        <p><b><U>あらすじ</U></b></p>
                        <P><?php echo "{$row['あらすじ']}" ;?></P>
